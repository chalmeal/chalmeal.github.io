...
| Go                    | 2年      | 独力で設計・開発可能 |
| PHP                   | 2年      | 独力で開発可能       |
| JavaScript/TypeScript | 2年      | 独力で開発可能       |

### フレームワーク・ライブラリ

| スキル             | 経験年数 | レベル               |
| ------------------ | -------- | -------------------- |
| SpringBoot         | 3年      | 独力で設計・開発可能 |
| Vue.js (Vuetify)   | 2年      | 独力で開発可能       |
| React (shadcn/MUI) | 2年      | 独力で開発可能       |
| Echo               | 2年      | 独力で開発可能       |
| Laravel            | 2年      | 独力で開発可能       |
| Spring Security    | 1年      | 独力で開発可能       |
| JPA / Hibernate    | 1年      | 独力で開発可能       |
| Selenium           | 1年半    | 独力で利用可能       |
| Gin                | 1年未満  | 個人開発レベル       |
| Spring Batch       | 1年未満  | 個人開発レベル       |
| GORM               | 1年未満  | 個人開発レベル       |
...
| AWS        | 4年      | 独力で設計・構築可能 |
| MySQL      | 3年      | 独力で設計・開発可能 |
| Docker     | 2年半    | 独力で設計・構築可能 |
| PostgreSQL | 1年半    | 独力で開発可能       |
| AWS S3     | 1年未満  | 独力で利用可能       |
...
| --------------- | -------- | -------------- |
| Git             | 3年以上  | 独力で利用可能 |
| Devcontainer    | 2年      | 独力で利用可能 |
| Swagger/OpenAPI | 2年      | 独力で利用可能 |
| Claude Code     | 1年      | 独力で利用可能 |
| Flyway          | 1年未満  | 個人開発レベル |
